...
setup(name='assistive-gym',
    ...
    install_requires=['gym>=0.15.7', 'pybullet @ git+https://github.com/Zackory/bullet3.git#egg=pybullet', 'numpy', 'keras==2.6.0', 'tensorflow==2.6.2', 'h5py==3.1.0', 'smplx', 'trimesh', 'ray[rllib]==1.3.0', 'numpngw', 'tensorflow-probability==0.7.0', 'lz4==3.1.3'] + ['screeninfo==0.6.1' if sys.version_info >= (3, 6) else 'screeninfo==0.2'],
